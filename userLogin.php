...
<html>
    ...
    <body style="background-image:url('log.jpg');background-size: cover;">
      <form method="POST" class="text-center" action="ValidateUser.php"> 
            <h1 style="padding-top:20px;text-align:center;margin-bottom:20px">Login Panel</h1>
            <label for="userid" style="margin-right: 32px;">Email</label>
            <input type="text" name="userid" id="userid" required><br> <br>      
            <label for="userpass" style="margin-right: 5px;">Password</label>
